	<link rel="stylesheet" href="assets/css/font-icons/font-awesome/css/font-awesome.min.css" id="style-font-awesome">
	...
	<script src="assets/js/jquery.tmpl.min.js" id="script-tmpl"></script>
